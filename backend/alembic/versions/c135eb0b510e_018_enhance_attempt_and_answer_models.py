...
down_revision: Union[str, None] = '017_enhance_assessment_models'
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_assessment_attempts_active_task_id'), 'assessment_attempts', ['active_task_id'], unique=False)
